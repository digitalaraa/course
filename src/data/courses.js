...
// import courseBg10 from '../assets/images/course-bg-1.webp';
...
//         description: "This course is a complete Python programming journey from beginner to advanced levels. You'll learn Python syntax, data structures, object-oriented programming, file handling, and working with APIs. The course also covers practical applications like web scraping, data analysis with Pandas, and building automation scripts. By the end, you'll be able to develop real-world Python applications and be prepared for specialized fields like data science or web development.",
//         lessons: 60,
//         rating: 4.9,
//         category: "Programming",
//         discount: "20% Off",
//         image: courseBg10,  // You'll need to import courseBg10 image
//         faq: [
//             { question: "Is Python good for beginners?", answer: "Yes! Python is one of the best first languages due to its simple syntax." },
//             { question: "What can I build with Python?", answer: "You can build web apps, data analysis tools, automation scripts, and even machine learning models." },
//             { question: "Will this course cover Django/Flask?", answer: "This course focuses on core Python, but we touch on web frameworks in advanced modules." },
//             { question: "Do I need any prior coding experience?", answer: "No, this course starts from absolute basics and progresses gradually." }
//         ]
//     }
// ];
...
import courseBg8 from '../assets/images/course-bg-8.webp';
import courseBg9 from '../assets/images/course-bg-9.webp';
import courseBg10 from '../assets/images/course-bg-4.webp';

export const allCourses = [
    {
        id: 1,
        title: "Complete UI/UX Design Mastery",
        description: "This comprehensive course takes you from UI/UX beginner to advanced practitioner. You'll start with design fundamentals (user research, wireframing) and progress to advanced topics (design systems, micro-interactions, UX psychology). Includes hands-on projects with Figma and Adobe XD, plus a certification project where you'll solve a real-world design problem end-to-end. Perfect for both newcomers and designers looking to upskill.",
        lessons: 60, // Combined lesson count
        rating: 4.8, // Averaged rating
        category: "UI/UX",
        discount: "20% Off",
        image: courseBg1,
        faq: [
            { question: "Who is this course for?", answer: "Beginners and intermediate designers looking for complete UI/UX training." },
            { question: "What tools will I learn?", answer: "Figma, Adobe XD, Miro, Protopie, and usability testing tools." },
            { question: "Will I build a portfolio?", answer: "Yes! You'll complete 5 portfolio-worthy projects." },
            { question: "Does this include UX research?", answer: "Yes, from basic user interviews to advanced analytics." }
        ]
    },
    {
        id: 2,
    ...
    },
    {
        ...
        description: "Learn to build cross-platform iOS and Android apps using React Native. This course covers everything from setting up your environment to publishing apps on stores. You'll master core concepts like components, navigation, state management with Redux, working with device APIs (camera, GPS), and Firebase integration. By the end, you'll build 3 complete apps including a social media clone with real-time features.",
        lessons: 48,
        rating: 4.8,
        ...
        image: courseBg8,
        faq: [
            { question: "Do I need to know React?", answer: "Yes, basic React knowledge is required for this course." },
            { question: "Can I build both iOS and Android apps?", answer: "Yes! React Native apps work on both platforms with single codebase." },
            { question: "Will we use Expo or bare React Native?", answer: "We start with Expo for rapid prototyping then transition to bare workflow." }
        ]
    },
    {
        id: 9,
